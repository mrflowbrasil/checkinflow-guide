...
export const SignupEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Confirme seu email para ativar a conta no {siteName}</Preview>
    <Body style={main}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            ...
            <Link href={siteUrl} style={link}>
              <strong>Mr Flow Welcome Hub</strong>
            </Link>
            ! Para ativar sua conta de anfitrião ({recipient}), confirme seu
