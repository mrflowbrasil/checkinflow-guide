...
const ENDPOINTS: Endpoint[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { name: "city", in: "body", type: "string", description: "Cidade do imóvel (ex.: \"Caruaru\"). Usada no Catálogo." },
      { name: "capacity", in: "body", type: "number", description: "Capacidade de hóspedes (aliases: max_guests, details.extras.max_guests)." },
      { name: "price_base", in: "body", type: "number", description: "Preço base da diária (alias: base_price)." },
      { name: "booking_url", in: "body", type: "string", description: "Link de reserva (Airbnb, Booking, site do cliente, etc.)." },
      { name: "latitude", in: "body", type: "number", description: "Latitude no nível raiz (alimenta property_details; pode vir também em details)." },
      { name: "longitude", in: "body", type: "number", description: "Longitude no nível raiz (idem latitude)." },
      ...
      { name: "details", in: "body", type: "object", description: "checkin_time, wifi_ssid, wifi_password, lock_code, rules, latitude, longitude, emergency_contacts[], extras{} etc. Campos location_url e intercom em details são mesclados em extras (geram blocos de Localização e Contatos)." },
