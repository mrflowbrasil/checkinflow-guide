...
import privacyRaw from "@/content/privacy-policy.txt?raw";

const SECTION_RE = /^\d+\.\s+[A-ZÁÉÍÓÚÂÊÔÃÕÇ0-9 ,\-—/]+$/;
const TITLE_RE = /^POLÍTICA DE PRIVACIDADE/i;
...
export default function Privacy() {
  const content = renderContent(privacyRaw);
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="Política de Privacidade — Mr Flow Welcome Hub"
        description="Política de Privacidade do Mr Flow Welcome Hub: como coletamos, usamos, armazenamos e protegemos seus dados pessoais conforme a LGPD."
        path="/privacidade"
      />
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 md:py-14">
        ...
        <p className="text-muted-foreground mb-8">
          Mr Flow Welcome Hub — como tratamos seus dados pessoais.
        </p>
